...
export interface ApiContentBlockContentBlock
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['tip', 'achievement', 'motivation', 'faq']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiMascotDialogueMascotDialogue
  ...
  info: {
    displayName: 'Mascot Dialogue';
    pluralName: 'mascot-dialogues';
    singularName: 'mascot-dialogue';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMascotMascot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    animationDuration: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    contexts: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultDialogue: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    gifFile: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::mascot.mascot'>;
    mascot_dialogues: Schema.Attribute.Relation<
      'oneToMany',
      'api::mascot-dialogue.mascot-dialogue'
    >;
    publishedAt: Schema.Attribute.DateTime;
    size: Schema.Attribute.Enumeration<['hero', 'card', 'icon', 'badge']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    state: Schema.Attribute.Enumeration<
      ['smile', 'cry', 'sleep', 'run', 'excecies', 'eat', 'skincare']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiMediaAssetMediaAsset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    file: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    fileDark: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    platforms: Schema.Attribute.Enumeration<['ios', 'android', 'web']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    screen: Schema.Attribute.Enumeration<
      ['home', 'camera', 'journey', 'profile', 'settings']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
